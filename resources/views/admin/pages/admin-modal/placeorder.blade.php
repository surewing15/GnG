                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="total_amount">Total Kilo <span class="text-danger">*</span></label>
                                        <input id="total_amount" type="text" class="form-control" name="total_amount" value="10kg" readonly required>
                                    </div>
                                </div>
                            </div>
